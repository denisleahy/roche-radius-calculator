...
public class MainFrame extends JFrame {
    ...
    public static final int DESC_HEIGHT = 500;
    public static final int COMP_WIDTH = 640;
    public static final int COMP_HEIGHT = 730;
	...
	CompareGraph.setBounds(0, 50, COMP_WIDTH, 320); 
	CompareDialog.add(CompareGraph);

	CompareText.setBounds(0, 370, COMP_WIDTH, 320);
